...
rawowners = "<h1 style='text-align: center'><a href='https://t.me/DOWNLOADERZONEUPDATES'>Downloader Zone</a></h1>"
...
<body>
    ...
    <header>
        <div class="brand">
            <img src="https://envs.sh/s/mZpwdESIV-nyGPHGDrXTQQ/7oi.jpg" alt="logo" />
        </div>
        <h2 class="name">Qbittorrent Selection</h2>
        <div class="social">
            <a href="https://github.com/DOWNLOADER-ZONE"><i class="fab fa-github"></i></a>
            <a href="https://t.me/DOWNLOADERZONEUPDATES"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
...
<footer style="height: 30%; text-align: center;">
    <p style="color: white; margin-top: 1vh;">&copy; 2025 Downloader Zone. All rights reserved.</p>
</footer>
