...
class YtDlp(TaskListener):
    ...
    async def newEvent(self):
        ...
        # Per-user YTDLP cookies logic
        cookies_path = ospath.join('cookies', f'{self.user_id}.txt')
        use_cookies = self.user_dict.get('ytdlp_cookies_enabled', False)
        if use_cookies and ospath.exists(cookies_path):
