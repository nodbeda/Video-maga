...
class _BotCommands:
    def __init__(self):
        ...
        self.Telegraph = [f'telegraph{CMD_SUFFIX}', f'graph{CMD_SUFFIX}', f'image{CMD_SUFFIX}', f'img{CMD_SUFFIX}', f'cloud{CMD_SUFFIX}']
        self.SwapCommand = [f'swap{CMD_SUFFIX}', f'replace{CMD_SUFFIX}']
