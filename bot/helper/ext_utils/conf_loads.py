...
default_values = {'AUTO_DELETE_MESSAGE_DURATION': 0,
                  ...
                  'FSUB_BUTTON_NAME': 'Join Downloader Zone Updates!',
                  'CHANNEL_USERNAME': 'DOWNLOADERZONEUPDATES',
                  'AUTHOR_NAME': 'Downloader Zone',
                  'AUTHOR_URL': 'https://t.me/dzonecontactbot',
                  'DRIVE_SEARCH_TITLE': 'Drive Search',
                  'GD_INFO': 'Uploaded By DZONE',
                  'RCLONE_TFSIMULATION': 0,
                  'SESSION_TIMEOUT': 0,
                  'PROG_FINISH': '',
                  'PROG_UNFINISH': '',
                  ...
                  'IMAGE_DEFAULT': 'https://envs.sh/s/mZpwdESIV-nyGPHGDrXTQQ/7oi.jpg',
                  'IMAGE_ARIA': '',
                  'IMAGE_AUTH': '',
                  'IMAGE_BOLD': '',
                  'IMAGE_BYE': '',
...
async def load_config():
    ...
    TIME_ZONE_TITLE = environ.get('TIME_ZONE_TITLE', '')
