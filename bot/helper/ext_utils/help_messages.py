...
<code>{{file_size}}</code> : File Size Of The Media. Like: 2.45GB
<code>{{file_caption}}</code> : Custom File Caption On Media
<code>{{languages}}</code> : All Languages In Media
<code>{{subtitles}}</code> : All Subtitles In Media. Like- English
<code>{{duration}}</code> : The Duration Of File In HH:MM:SS Format
<code>{{ott}}</code> : For OTT, Like- NF, AMZN etc
<code>{{resolution}}</code> : Video Resolution. Like:- 480p, 720p
<code>{{name}}</code> : The File Name Only, Like: Premi Babu
<code>{{year}}</code> : Year On The Media Name
<code>{{quality}}</code> : Quality Of The File. Like:-  WEB-DL, WEBRip, BluRay etc.
<code>{{season}}</code> : Season Of The File, Like- S01
<code>{{episode}}</code> : Episode Of The File, Like- E03
<code>{{audio}}</code> : Audio Type Of The Media, Like- AAC, 6CH etc
<code>{{lib}}</code> : Codec Library Of Media, Like- x264, x265
<code>{{extension}}</code> : Extension Of The File, Like- .mkv, .mp4, .web etc
<code>{{shortsub}}</code> : ShortSub Of The Subtitles, Like- MSub, ESub, HSub Etc\n
...
Send Metadata Split title for video file \n author|title|subtitle|audio \n
<b>Current:</b> <code>{}</code>\n
<i>Timeout: 60s.</i>
'''
...
class HelpString:
    ...
    USER = [f'/{BotCommands.RssCommand}: RSS Menu (list, sub, unsub, etc).',
            ...
            f'/{BotCommands.Telegraph[0]}: To Upload Image On Cloud',
            f'/{BotCommands.SwapCommand[0]}: To Swap Any Existing TG Message',
